    ...
    implements PropertyChangedListener, StateChangedListener, MessageReceivedListener
{
    ...
    public function AlphaBout ()
    {
        ...
        if (_gameCtrl.seating.getMyPosition() != -1) {
    ...
    public function messageReceived (event :MessageReceivedEvent) :void
    {
        ...
        if (name == NEW_PIECE) {
            ...
            if (valueArray.length == 0) {
                _gameCtrl.endGame(_gameObject.seating.getMyPosition());
            }
            */
    ...
    {
        var playerNames :Array = _gameCtrl.seating.getPlayerNames();
        for (var ii :int = 0; ii < playerNames.length; ii++) {
            _gameCtrl.collections.deal(PIECE_BAG, count, NEW_PIECE, null, ii);
        }
    }
    ...
    protected function setupPieceBag () :void
    {
        ...
        _gameCtrl.collections.create(PIECE_BAG, bag);
    }
