...
public class Ball extends Shape
{
            ...
            if (t >= 1 && _pidx < _path.length - 2) {
                ...
                if (dy > 0 && _path == null) { // reattach
                    ...
                    _gameCtrl.set(BALL_STATES,
                        createState(_gameCtrl.seating.getMyPosition()), getIndex());
                }
                return;
            }
        }
    ...
    protected function propChanged (event :PropertyChangedEvent) :void
    {
        ...
        if (state.pidx == _gameCtrl.seating.getMyPosition()) {
    ...
    protected function release () :void
    {
        ...
        _gameCtrl.set(BALL_STATES,
            createState(_gameCtrl.seating.getMyPosition(), followNewPath(_x, angle)),
            getIndex());
    }
        ...
        hx :Number, incidence :Number, penetration: Number) :void
    {
        ...
        // fire the ball and announce the update
        _gameCtrl.set(BALL_STATES,
            createState(_gameCtrl.seating.getMyPosition(),
    ...
    {
        var pidx :int = _gameCtrl.seating.getMyPosition();
