...
public class SharedPlayerStateServer //implements IExternalizable
{
    ...
    */
    ...
    public function SharedPlayerStateServer( ctrl :PlayerSubControlServer)
    {
        ...
        var bloodbonded :Object = _ctrl.props.get(PLAYER_PROP_PREFIX_BLOODBONDED);
        if (bloodbonded != null) {
    ...
    public function setAction (action :String, force :Boolean = false) :void
    {
        ...
        // persist it, too
        _ctrl.props.set(PLAYER_PROP_PREFIX_ACTION, _action, true);
    }
    ...
    protected function setBloodBonded (bloodbonded :Array, force :Boolean = false) :void
    {
        // update our runtime state
        if (!force && ArrayUtil.equals(bloodbonded, _bloodbonded) ) {
            return;
        }
        _bloodbonded = bloodbonded;

        // persist it, too
        _ctrl.props.set(PLAYER_PROP_PREFIX_BLOODBONDED, _bloodbonded, true);
    }
