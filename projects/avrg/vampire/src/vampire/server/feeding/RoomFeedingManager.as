...
public class RoomFeedingManager extends BasicGameObject
{
    public function RoomFeedingManager(room :Room)
    {
        _room = room;
    }
...
//    }
    ...
    protected static const log :Log = Log.getLog(RoomFeedingManager);
}
}
