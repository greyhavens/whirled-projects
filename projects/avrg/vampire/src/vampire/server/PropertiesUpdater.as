...
/**
 * Copies the data into props only on the update loop.
 * This can be controlled by the server for bundled updates.
 */
public class PropertiesUpdater
    implements Updatable
{
    public function PropertiesUpdater(props :PropertySubControl, propsKeys :Array = null)
    {
        _props = props;
    ...
    protected static const log :Log = Log.getLog(PropertiesUpdater);
