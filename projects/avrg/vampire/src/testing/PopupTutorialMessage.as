 ...
 *
 */
public class PopupTutorialMessage extends DraggableSceneObject
{
    public function PopupTutorialMessage(ctrl :AVRGameControl, message :String, target :SceneObject = null)
    {
        super(ctrl, NAME);
