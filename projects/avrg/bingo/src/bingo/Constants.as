...
public class Constants
{
    ...
    public static const ITEMS :Array = [
        ...
        new BingoItem("owl",            [ "bird", "flying", "eggs", "predator" ]),
        ...
        new BingoItem("moth",           [ "insect", "flying", "eggs", /*"forest"*/ ]),
        new BingoItem("cicada",         [ "insect", "flying", "eggs" ]),
        new BingoItem("earwig",         [ "insect", "flying", "eggs", /*"soil"*/ ]),
        new BingoItem("butterfly",      [ "insect", "flying", "eggs", /*"forest"*/ ]),
        ...
        new BingoItem("catfish",        [ "fish", "aquatic", "eggs", /*"river"*/ ]),
        new BingoItem("eel",            [ "fish", "aquatic", "eggs", "predator", /*"ocean"*/ ]),
        new BingoItem("albacore",       [ "fish", "aquatic", "eggs", "predator", /*"ocean"*/ ]),
        new BingoItem("great white",    [ "fish", "aquatic", "eggs", "predator", /*"ocean"*/ ]),
        
        // rodent
        new BingoItem("capybara",       [ "rodent", "mammal", "semi-aquatic" ]),
        ...
        new BingoItem("sea turtle",     [ "reptile", "eggs", /*"ocean"*/ ]),
        new BingoItem("alligator",      [ "reptile", "eggs", "predator", /*"river"*/ ]),
        ...
        new BingoItem("bat",            [ "mammal", "flying", "predator", /*"cave"*/ ]),
