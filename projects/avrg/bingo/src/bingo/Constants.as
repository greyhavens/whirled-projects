...
public class Constants
{
    ...
    public static const ITEMS :Array = [
        ...
        new BingoItem("bobby pins", ["head", "hair", "gem", "beaded", ], Resources.IMG_BOBBYPINS),
        new BingoItem("patterned barrette 1", ["head", "hair", "pattern", ], Resources.IMG_BARRETTEPATTERN01),
        new BingoItem("patterned barrette 2", ["head", "hair", "pattern", ], Resources.IMG_BARRETTEPATTERN02),
        new BingoItem("patterned barrette 3", ["head", "hair", "pattern", ], Resources.IMG_BARRETTEPATTERN03),
        ...
        new BingoItem("fabric headband 1", ["head", "hair", "pattern", "green", ], Resources.IMG_FABRICHEADBAND01),
        new BingoItem("fabric headband 2", ["head", "hair", "pattern", "stripes", "animal", ], Resources.IMG_FABRICHEADBAND02),
        ...
        new BingoItem("fabric headband 5", ["head", "hair", "pattern", ], Resources.IMG_FABRICHEADBAND05),
        new BingoItem("fabric headband 6", ["head", "hair", "pattern", "white", "polka-dot", ], Resources.IMG_FABRICHEADBAND06),
        new BingoItem("fabric headband 7", ["head", "hair", "pattern", "red", ], Resources.IMG_FABRICHEADBAND07),
        new BingoItem("fabric headband 8", ["head", "hair", "pattern", "red", "plaid", ], Resources.IMG_FABRICHEADBAND08),
        new BingoItem("fabric headband 9", ["head", "hair", "pattern", "blue", ], Resources.IMG_FABRICHEADBAND09),
        new BingoItem("fabric headband 10", ["head", "hair", "pattern", ], Resources.IMG_FABRICHEADBAND10),
        new BingoItem("fabric headband 11", ["head", "hair", "pattern", "brown", "animal", ], Resources.IMG_FABRICHEADBAND11),
        new BingoItem("fabric headband 12", ["head", "hair", "pattern", "pink", ], Resources.IMG_FABRICHEADBAND12),
        new BingoItem("fabric headband 13", ["head", "hair", "pattern", "green", ], Resources.IMG_FABRICHEADBAND13),
        new BingoItem("fabric headband 14", ["head", "hair", "pattern", "red", "orange", ], Resources.IMG_FABRICHEADBAND14),
        new BingoItem("fabric headband 15", ["head", "hair", "pattern", "yellow", "animal", ], Resources.IMG_FABRICHEADBAND15),
        new BingoItem("fabric headband 16", ["head", "hair", "pattern", "white", ], Resources.IMG_FABRICHEADBAND16),
