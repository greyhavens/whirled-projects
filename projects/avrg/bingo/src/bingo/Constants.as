...
public class Constants
{
    ...
    public static const ITEMS :Array = [
        ...
        new BingoItem("patterned heel 3", ["feet", "shoes", "heel", "pattern", "blue", ], Resources.IMG_HEELPATTERN03),
        new BingoItem("patterned heel 4", ["feet", "shoes", "heel", "pattern", "white", "polka-dot", ], Resources.IMG_HEELPATTERN04),
        new BingoItem("patterned heel 5", ["feet", "shoes", "heel", "pattern", "pink", "purple", "orange", ], Resources.IMG_HEELPATTERN05),
        ...
        new BingoItem("brown boot", ["feet", "shoes", "boot", "brown", "winter", "heel", ], Resources.IMG_TALLBOOTBROWN),
        ...
        new BingoItem("patterned flat 1", ["feet", "shoes", "flat", "pattern", "summer", "green", ], Resources.IMG_FLATSPATTERN01),
        new BingoItem("patterned flat 2", ["feet", "shoes", "flat", "pattern", "summer", "red", "orange", ], Resources.IMG_FLATSPATTERN02),
        new BingoItem("patterned flat 3", ["feet", "shoes", "flat", "pattern", "summer", "stripes", "animal", ], Resources.IMG_FLATSPATTERN03),
        new BingoItem("patterned flat 4", ["feet", "shoes", "flat", "pattern", "summer", "plaid", ], Resources.IMG_FLATSPATTERN04),
        new BingoItem("patterned flat 5", ["feet", "shoes", "flat", "pattern", "summer", "white", "polka-dot", ], Resources.IMG_FLATSPATTERN05),
        new BingoItem("patterned flat 6", ["feet", "shoes", "flat", "pattern", "summer", "red", ], Resources.IMG_FLATSPATTERN06),
        new BingoItem("patterned flat 7", ["feet", "shoes", "flat", "pattern", "summer", "brown", "animal", ], Resources.IMG_FLATSPATTERN07),
        new BingoItem("blue sneakers", ["feet", "shoes", "flat", "blue", "stripes", ], Resources.IMG_SNEAKERSBLUE),
        new BingoItem("green sneakers", ["feet", "shoes", "flat", "green", "stripes", ], Resources.IMG_SNEAKERSGREEN),
        new BingoItem("orange sneakers", ["feet", "shoes", "flat", "orange", "stripes", ], Resources.IMG_SNEAKERSORANGE),
        new BingoItem("pink sneakers", ["feet", "shoes", "flat", "pink", "stripes", ], Resources.IMG_SNEAKERSPINK),
        new BingoItem("purple sneakers", ["feet", "shoes", "flat", "purple", "stripes", ], Resources.IMG_SNEAKERSPURPLE),
        new BingoItem("red sneakers", ["feet", "shoes", "flat", "red", "stripes", ], Resources.IMG_SNEAKERSRED),
        new BingoItem("yellow sneakers", ["feet", "shoes", "flat", "yellow", "stripes", ], Resources.IMG_SNEAKERSYELLOW),
        ...
        new BingoItem("fabric headband 1", ["head", "hair accessory", "pattern", "green", ], Resources.IMG_FABRICHEADBAND01),
        new BingoItem("fabric headband 2", ["head", "hair accessory", "pattern", "stripes", "animal", ], Resources.IMG_FABRICHEADBAND02),
        new BingoItem("fabric headband 3", ["head", "hair accessory", "pattern", "green", "plaid", ], Resources.IMG_FABRICHEADBAND03),
        new BingoItem("fabric headband 4", ["head", "hair accessory", "pattern", "brown", "polka-dot", ], Resources.IMG_FABRICHEADBAND04),
        new BingoItem("fabric headband 5", ["head", "hair accessory", "pattern", ], Resources.IMG_FABRICHEADBAND05),
        new BingoItem("fabric headband 6", ["head", "hair accessory", "pattern", "white", "polka-dot", ], Resources.IMG_FABRICHEADBAND06),
        new BingoItem("fabric headband 7", ["head", "hair accessory", "pattern", "red", ], Resources.IMG_FABRICHEADBAND07),
        new BingoItem("fabric headband 8", ["head", "hair accessory", "pattern", "red", "plaid", ], Resources.IMG_FABRICHEADBAND08),
        new BingoItem("fabric headband 9", ["head", "hair accessory", "pattern", "blue", ], Resources.IMG_FABRICHEADBAND09),
        new BingoItem("fabric headband 10", ["head", "hair accessory", "pattern", ], Resources.IMG_FABRICHEADBAND10),
        new BingoItem("fabric headband 11", ["head", "hair accessory", "pattern", "brown", "animal", ], Resources.IMG_FABRICHEADBAND11),
        new BingoItem("fabric headband 12", ["head", "hair accessory", "pattern", "pink", ], Resources.IMG_FABRICHEADBAND12),
        new BingoItem("fabric headband 13", ["head", "hair accessory", "pattern", "green", ], Resources.IMG_FABRICHEADBAND13),
        new BingoItem("fabric headband 14", ["head", "hair accessory", "pattern", "red", "orange", ], Resources.IMG_FABRICHEADBAND14),
        new BingoItem("fabric headband 15", ["head", "hair accessory", "pattern", "yellow", "animal", ], Resources.IMG_FABRICHEADBAND15),
        new BingoItem("fabric headband 16", ["head", "hair accessory", "pattern", "white", ], Resources.IMG_FABRICHEADBAND16),
        new BingoItem("fabric headband 17", ["head", "hair accessory", "pattern", "green", "polka-dot", ], Resources.IMG_FABRICHEADBAND17),
        ...
        new BingoItem("patterned bow clips 1", ["head", "hair accessory", "pattern", "bow", "pink", ], Resources.IMG_BOWCLIPSPATTERN01),
        new BingoItem("patterned bow clips 2", ["head", "hair accessory", "pattern", "bow", "red", ], Resources.IMG_BOWCLIPSPATTERN02),
        new BingoItem("patterned bow clips 3", ["head", "hair accessory", "pattern", "bow", "blue", ], Resources.IMG_BOWCLIPSPATTERN03),
        new BingoItem("patterned bow clips 4", ["head", "hair accessory", "pattern", "bow", "green", ], Resources.IMG_BOWCLIPSPATTERN04),
        new BingoItem("patterned bow clips 5", ["head", "hair accessory", "pattern", "bow", "animal", ], Resources.IMG_BOWCLIPSPATTERN05),
        ...
        new BingoItem("patterned tote 1", ["bag", "tote", "pattern", "stripes", "animal", ], Resources.IMG_TOTEPATTERN01),
        new BingoItem("patterned tote 2", ["bag", "tote", "pattern", "brown", ], Resources.IMG_TOTEPATTERN02),
        new BingoItem("patterned tote 3", ["bag", "tote", "pattern", "pink", "white", "polka-dot", ], Resources.IMG_TOTEPATTERN03),
        new BingoItem("patterned tote 4", ["bag", "tote", "pattern", "red", ], Resources.IMG_TOTEPATTERN04),
        new BingoItem("patterned tote 5", ["bag", "tote", "pattern", "blue", ], Resources.IMG_TOTEPATTERN05),
        new BingoItem("patterned tote 6", ["bag", "tote", "pattern", "green", ], Resources.IMG_TOTEPATTERN06),
        ...
        new BingoItem("patterned tote 9", ["bag", "tote", "pattern", "pink", "white", ], Resources.IMG_TOTEPATTERN09),
        new BingoItem("patterned tote 10", ["bag", "tote", "pattern", "pink", "purple", "orange", ], Resources.IMG_TOTEPATTERN10),
        new BingoItem("patterned tote 11", ["bag", "tote", "pattern", "yellow", "animal", ], Resources.IMG_TOTEPATTERN11),
        new BingoItem("patterned tote 12", ["bag", "tote", "pattern", "white", ], Resources.IMG_TOTEPATTERN12),
        new BingoItem("patterned tote 13", ["bag", "tote", "pattern", "black", "white", ], Resources.IMG_TOTEPATTERN13),
        new BingoItem("patterned tote 14", ["bag", "tote", "pattern", "yellow", ], Resources.IMG_TOTEPATTERN14),
