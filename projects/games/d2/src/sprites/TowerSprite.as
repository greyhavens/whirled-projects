...
public class TowerSprite extends UnitSprite
{
    ...
    public function TowerSprite (tower :Tower, board :Board)
    {
        super(tower, board);
    }
    ...
    override protected function loadStateAssets () :Array // of DisplayObject
    {
        ...
        return [ new tower.tdef.animationRest(),
                 new tower.tdef.animationRight(),
                 new tower.tdef.animationUp(),
                 new tower.tdef.animationLeft(),
                 new tower.tdef.animationDown()
            ];
    }
