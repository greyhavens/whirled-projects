package joingame.modes
{
    ...
    public class SinglePlayerIntroMode extends AppMode
    {
        ...
        override protected function enter ():void
        {
            ...
            modeSprite.addChild( startWavesButton );
            ...
            modeSprite.addChild( startWithXOpponentsButton );
        ...
        {
            var msg :StartSinglePlayerGameMessage = new StartSinglePlayerGameMessage( AppContext.playerId, Constants.SINGLE_PLAYER_GAME_TYPE_WAVES);
        ...
        {
            var msg :StartSinglePlayerGameMessage = new StartSinglePlayerGameMessage( AppContext.playerId, Constants.SINGLE_PLAYER_GAME_TYPE_CHOOSE_OPPONENTS, 10);
            log.debug("Client sending " + msg);
            AppContext.messageManager.sendMessage(msg);
        }
