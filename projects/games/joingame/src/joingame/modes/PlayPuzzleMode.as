package joingame.modes
{
    ...
    public class PlayPuzzleMode extends AppMode
    {
        ...
        override protected function setup () :void
        {
            ...
            var backgroundPlayerClass :Class = swf.getClass("piece_back_player");
            var backgroundOpponentClass :Class = swf.getClass("piece_back_opponent");
            
            var backgroundPlayerClip :MovieClip = new backgroundPlayerClass();
            _modeSprite.addChild(backgroundPlayerClip);
...
//            _modeSprite.addChild(_boardsView.displayObject);
//            
...
//            trace("\nWhen id="+AppContext.gameCtrl.game.getMyId()+" starts, left="+_gameModel.getPlayerIDToLeftOfPlayer(AppContext.gameCtrl.game.getMyId() )+ ", right="+_gameModel.getPlayerIDToRightOfPlayer(AppContext.gameCtrl.game.getMyId() ));
            ...
            allOpponentsView = new AllOpponentsView(AppContext.gameCtrl, _gameModel.currentSeatingOrder);
            addObject(allOpponentsView, _modeSprite);
            allOpponentsView.init();
