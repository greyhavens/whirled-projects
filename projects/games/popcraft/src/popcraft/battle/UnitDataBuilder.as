...
public class UnitDataBuilder
{
    ...
    public function weapon (val :UnitWeapon) :UnitDataBuilder { _unitData.weapons = [ val ]; return this; }
    public function weapons (val :Array) :UnitDataBuilder { _unitData.weapons = val; return this; }
