    ...
    implements MessageReceivedListener
{
    ...
    public static const MSG_ADD :String = "MessageAdd";
    public static const MSG_REMOVE :String = "MessageRemove";
    public static const MSG_UPDATE :String = "MessageUpdate";

    public function Validator (sharedState :SharedState, whirled :WhirledGameControl)
    {
        ...
        _handlers[MSG_ADD] = handleAdd;
//        _handlers[MSG_REMOVE] = handleRemove;
//        _handlers[MSG_UPDATE] = handleUpdate;
    }
